...
parser.add_argument('--color_img_dir', type=str, default=r'C:\Users\WangChun\Desktop\Laplace_Filter\input',        #设置高分辨率图片路径参数
                    help='path to Color image dir')
parser.add_argument('--laplace_img_dir', type=str, default=r'C:\Users\WangChun\Desktop\Laplace_Filter\result',       #设置低分辨率路径参数
